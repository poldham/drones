#' @title Access drones patent data from the Lens
#' @description A set of 9071 patent documents from the open access Lens patent database containing the word drone or drones in the full text of documents published between 1948 and the 31st of December 2017 and reduced from 16,419 publications to one record per family. The records can be accessed online at the public collection \href{https://www.lens.org/lens/collection/45155}{https://www.lens.org/lens/collection/45155}.
#' @details Field names in this dataset have been simplified from their original long form to make them easier to work with in R. Lens Patent data fields are concatenated with a double semicolon and require tidying for accurate counts. Applicant and inventor names have not been cleaned.
#' @usage data("lens_drones")
#' @aliases lens_drones
...
#'  }
#' }
#' @source \href{https://www.lens.org/lens/collection/45155}{The Lens Patent Databse}
"lens_drones"