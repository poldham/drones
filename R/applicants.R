...
#' @description Patent applicant names (also known as assignees) from a set of 18,970 patent publications containing the word drone or drones published between 1845 and the 2nd of November 2017 from the \href{https://clarivate.com/products/derwent-innovation/}{Clarivate Analytics Derwent Innovation} database.
